            ...
            <div className="container">
                <div className="lg:flex grid grid-cols-1 sm:grid-cols-2 gap-7 md:gap-4 items-center">
                    <div className="flex flex-col gap-4 md:gap-7 max-w-2xl">
                        ...
                        <p className="text-secondary font-normal max-w-md xl:max-w-xl"> Welcome to my webpage i am a develper full-stack for all services contact on my email or through the number below</p>
                    </div>
